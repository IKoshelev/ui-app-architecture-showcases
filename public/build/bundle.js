...
var app = (function () {
    ...
    function createStore() {
        ...
        return {
            subscribe,
            applyDiff: (diff) => update(state => Object.assign(state, diff)),
        };
    }
    const clockEffects = {
        start(clockStore) {
    ...
    function create_fragment(ctx) {
    	...
    	let t7;
    	let p1;
    	let t8_value = /*$clockStore*/ ctx[1].currentDate + "";
    	let t8;
    	let t9;
    	let p2;

    	let t10_value = (/*$clockStore*/ ctx[1].tickIntervalHandle
    	? 'is ticking'
    	: 'is NOT ticking') + "";
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 5, 1, 124);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file, 6, 14, 162);
    			add_location(p0, file, 6, 1, 149);
    			add_location(p1, file, 7, 4, 264);
    			add_location(p2, file, 10, 4, 318);
    			add_location(button0, file, 13, 4, 413);
    			add_location(button1, file, 14, 4, 489);
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$clockStore*/ 2 && t8_value !== (t8_value = /*$clockStore*/ ctx[1].currentDate + "")) set_data_dev(t8, t8_value);

    			if (dirty & /*$clockStore*/ 2 && t10_value !== (t10_value = (/*$clockStore*/ ctx[1].tickIntervalHandle
    			? 'is ticking'
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, clockStore, $$value => $$invalidate(1, $clockStore = $$value));
    	...
    	return [name, $clockStore, click_handler, click_handler_1];
    }
